      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse text-center" id="mymenu">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="pending.php">Pending Journals</a>
            </li>
            <li class="nav-item">
...
<script type="text/javascript">
 ...
 function readRecordsPending(){
  var readRecordsPending = "readRecordsPending";
  $.ajax({
    url: "backend.php",
    type: 'POST',
    data: { readRecordsPending : readRecordsPending},
 ...
 function chngstatus(jor_id){
  var conf = confirm("Are you sure you want to accept this record?");
  if(conf == true){
    $.ajax({
        url: 'backend.php',
        type: "POST",
