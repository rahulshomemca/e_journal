...
<div class="container">
  <h3>List Of All Faculty</h3>
   ...
   <div class="d-flex justify-content-end">
        <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#myModal">Add Faculty</button>
      </div>
      <br>
      <!-- Table -->
      <div id="record_table">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h4 class="modal-title text-primary">Enter Faculty Details</h4>
            ...
            <div class="modal-body">
                ...
                Designation:<input type="text" name="desig" id="desig" class="form-control"><br> 
      ...
      <div class="modal fade" id="update_modal">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h4 class="modal-title text-primary">Update Faculty Details</h4>
              <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            ...
            <div class="modal-body">
                ...
                Designation:<input type="text" name="desig" id="updatedesig" class="form-control"><br> 
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                Designation:<input type="text" name="desig" id="viewdesig" class="form-control"><br> 
 ...
 function readRecords(){
  ...
  $.ajax({
   ...
   function AddRecord(){
     ...
     if(name == '' || email == '' || mobile == '' || desig == '' || dept == '')
          {
 ...
 $("#hidden_student_id").val(updateid);
    ...
    $.ajax({
        ...
        success: function(data,status){
          ...
          $('#updatedesig').val(student.designation);
        }
    });
 ...
 $("#hidden_student_id").val(viewid);
    ...
    $.ajax({
        ...
        success: function(data,status){
          ...
          $('#viewdesig').val(candidate.designation);
        }
    });
...
function updatedetails(){
     ...
     var updatedesig = $('#updatedesig').val();
     
     var hidden_student_id = $('#hidden_student_id').val();

     if(updatename == '' || updateemail == '' || updatemobile == '' || updatedesig == '')
          {
